...
These exact pairs are tested against the current source tree, versioned `4.2.1`,
including the unreleased compatibility fix. They are also pinned in the
[Pydantic AI compatibility CI job](https://github.com/confident-ai/deepeval/blob/main/.github/workflows/test_integrations.yml).
