...
September's release brings significant improvements to voice mode, introducing support for multiple speech providers and enhanced configuration options for text-to-speech and speech-to-text models. The conversation simulator now supports true parallelism with configurable concurrency, allowing for more realistic and scalable simulations. Voice simulations benefit from full conversation audio recording, improved turn detection, and detailed latency metrics, making it easier to analyze and debug interactions. Additionally, OpenTelemetry integrations have been refined to ensure accurate tool usage data in tracing outputs.

### New Feature

#### v4.2.1
- Add support for multiple speech providers in voice mode, including ElevenLabs, Deepgram, Cartesia, and AssemblyAI, with new environment variables to configure text-to-speech and speech-to-text providers and models. Improve voice simulation by recording full call audio, providing detailed latency logs, and supporting full-duplex conversation handling. Update documentation pointers for new voice features and configuration options. Refactor imports for speech model modules and add CLI app structure. ([#3139](https://github.com/confident-ai/deepeval/pull/3139)) {/* pr:3139 */} ([Jeffrey Ip](https://github.com/penguine-ip))
- Add support for configuring the maximum number of concurrent conversations in the conversation simulator. Each conversation now gets its own connector instance, enabling true parallelism up to the specified limit. This improves scalability and allows for more realistic simulation of multiple simultaneous voice interactions. ([#3148](https://github.com/confident-ai/deepeval/pull/3148)) {/* pr:3148 */} ([Tanay](https://github.com/tanayvaswani))
- Add support for recording full conversation audio in voice simulations, including stereo WAV output with caller and agent channels. Improve turn detection and handling for duplex connectors, ensuring more accurate simulation of real conversations. Verbose logs for voice metrics now display breakdowns as indented JSON with rounded floats for easier reading. Update voice QA workflow and documentation to reflect these enhancements. ([#3163](https://github.com/confident-ai/deepeval/pull/3163)) {/* pr:3163 */} ([Tanay](https://github.com/tanayvaswani))


### Bug Fix

#### v4.2.1
- Fix application of tools_called and expected_tools fields in OpenTelemetry integrations to ensure correct span attribute handling. This improves the accuracy and completeness of tool usage data in tracing outputs. ([#3103](https://github.com/confident-ai/deepeval/pull/3103)) {/* pr:3103 */} ([Vamshi Adimalla](https://github.com/A-Vamshi))



## August

August brought significant improvements to the developer tool, focusing on enhanced evaluation workflows, expanded TypeScript support, and greater flexibility in authentication and data management. Key metrics were updated to align with standard scoring conventions, and new features such as voice conversation simulations and a setup wizard streamlined both testing and onboarding. Numerous bug fixes addressed edge cases in metrics, dataset serialization, and documentation clarity, while updates to prompt wording and model references improved compatibility and user experience. The release also introduced robust support for flaky test handling, component-level evaluations, and integration with
...
June's release brings major enhancements to evaluation flexibility and transparency, with expanded support for new models like Gemini 3 and Claude Opus 4-8, including multimodal and structured output capabilities. The TypeScript SDK and CLI gain new features for governance checks and comprehensive metric support, while dataset versioning and improved context synthesis enable better reproducibility and multi-file project support. Token and cost tracking are now surfaced throughout the tool, providing users with clearer insights into resource usage. Numerous documentation updates and bug fixes improve clarity, reliability, and integration with custom models and external providers, ensuring a a
...
May was a month of significant enhancements focused on multimodal support, expanded integrations, and improved observability for Python AI applications. The release introduced robust handling of images and PDFs in traces, deeper integration with platforms like Google ADK and Strands, and new skills for agent frameworks such as Cursor and Claude. Prompt optimization algorithms received both performance and documentation upgrades, while tracing and evaluation workflows became more flexible and transparent with new metadata fields and improved reporting. Numerous reliability improvements, expanded test coverage, and refined documentation further streamlined the developer experience and ensured,
...
January saw major improvements in model integration, authentication, and documentation across the tool. New support for OpenRouter and Azure AD authentication expands model and provider compatibility, while enhancements to tracing, metric collection, and error handling make integrations with LangChain, LangGraph, and Pydantic AI more robust and reliable. The release also introduces an automated changelog generator and updates documentation for clarity and easier navigation. Numerous bug fixes address edge cases in evaluation, tracing, and response parsing, resulting in a smoother and more predictable developer experience.
