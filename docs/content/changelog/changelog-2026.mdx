...
August was a month of significant enhancements and refinements for the developer tool, with a strong focus on improving evaluation workflows, onboarding, and cross-language support. Major updates included a directional change in metric scoring logic to align with industry standards, expanded support for voice conversation simulations, and the introduction of a setup wizard for easier installation. TypeScript integrations saw substantial growth, with new unit test architectures, component-level evaluations, and Mastra framework support. Numerous bug fixes and documentation improvements were made to ensure reliability, clarity, and a smoother user experience across both Python and TypeScript.
...
#### v4.2.0
- Add agent discovery endpoints and WebMCP tools, making the site discoverable and consumable by AI agents. Support Markdown content negotiation, provide RFC-compliant API and skills catalogs, and expose AI-friendly metadata via robots.txt and Link headers. Introduce in-browser tools for searching docs, retrieving page markdown, and listing agent resources. All endpoints verified for correct status codes and content types. ([#3109](https://github.com/confident-ai/deepeval/pull/3109)) {/* pr:3109 */} ([Tony](https://github.com/tony-confidentai))
...
#### v4.2.0
- Update the changelog generation script to use the gpt-4.1 model and improve compatibility with monorepo tag schemes. The script now correctly handles tags with SDK-specific prefixes and ensures changelog entries display consistent version formatting. Existing PRs are tracked more reliably to prevent duplicate entries across releases. Command-line arguments are updated to support multiple tags and the new model by default. ([#3105](https://github.com/confident-ai/deepeval/pull/3105)) {/* pr:3105 */} ([Vamshi Adimalla](https://github.com/A-Vamshi))
- Update changelogs to include all new features, improvements, and fixes released up to August 2026, ensuring documentation accurately reflects the latest changes and enhancements for users. ([#3106](https://github.com/confident-ai/deepeval/pull/3106)) {/* pr:3106 */} ([Vamshi Adimalla](https://github.com/A-Vamshi))
- Update the documentation banner to inform users about changes in metrics' scoring logic, clarifying that higher scores now indicate better performance. This helps users stay aware of important evaluation convention updates. ([#3107](https://github.com/confident-ai/deepeval/pull/3107)) {/* pr:3107 */} ([Vamshi Adimalla](https://github.com/A-Vamshi))
...
#### v4.2.0
- Fix update and deletion of golden test cases by correcting endpoint and URL parameters, ensuring golden methods work reliably with the correct API routes. ([#3020](https://github.com/confident-ai/deepeval/pull/3020)) {/* pr:3020 */} ([Vamshi Adimalla](https://github.com/A-Vamshi))
...
April's release focused on streamlining configuration and improving model support, with legacy options removed in favor of clearer, more consistent APIs. Major enhancements include new CLI tools for generating synthetic goldens, expanded tracing and metadata capabilities, and support for the latest OpenAI and Anthropic models. The documentation site was overhauled for better usability, and numerous fixes addressed trace accuracy, schema handling, and evaluation workflows. These updates make the tool more robust, easier to configure, and better suited for modern Python development and evaluation needs.
...
March was a month of significant improvements in observability, reliability, and flexibility for the tool. Major highlights include deepened OpenTelemetry and OpenInference integrations, enabling richer tracing and metric collection for agents, tools, and LLMs, with robust export and validation options. The release also focused on fixing a wide range of bugs affecting trace accuracy, evaluation consistency, and provider configuration, while enhancing support for multiple backends and improving documentation. Code quality and test stability were further strengthened through formatting updates and better handling of edge cases, ensuring a smoother developer experience.
