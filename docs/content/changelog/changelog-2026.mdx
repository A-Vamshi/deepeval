...
September's release focused on enhancing compatibility with Pydantic AI, ensuring seamless integration and robust support for both 1.x and 2.x versions. Updates addressed field validation aliases and improved the extraction of tool input and output from OpenTelemetry spans, resulting in more reliable agent instrumentation and clearer documentation for users working across different Pydantic AI versions.

### Improvement

#### v4.2.2
- Improve compatibility with Pydantic AI by updating integration and documentation to support both 1.x and 2.x versions, including correct handling of agent instrumentation and tool argument/result extraction. Fixes issues with field validation aliases and ensures tool input/output are properly extracted from OpenTelemetry spans for all supported Pydantic AI versions. ([#3252](https://github.com/confident-ai/deepeval/pull/3252)) {/* pr:3252 */} ([Jeffrey Ip](https://github.com/penguine-ip))



## August

August brought significant improvements to the developer tool, focusing on enhanced evaluation workflows, expanded TypeScript support, and greater flexibility in authentication and data management. Key metrics were updated to align with standard scoring conventions, and new features such as voice conversation simulations and a setup wizard streamlined both testing and onboarding experiences. Numerous bug fixes and documentation updates improved reliability, clarity, and compatibility across integrations, while new controls for flaky tests and component-level evaluations provided users with more granular insight and control over their testing processes.
...
May's release brings significant enhancements to multimodal tracing, enabling seamless analysis of workflows involving images and PDFs. The conversation simulator now supports flexible simulation graphs, offering advanced control over conversation flows and improved extensibility. Integrations have expanded to include Google ADK and the Strands framework, with robust support for OpenTelemetry-based tracing and detailed observability. Prompt optimization algorithms have been refined for efficiency and clarity, while new skills and improved documentation make it easier to instrument and evaluate AI applications across a variety of platforms. Numerous reliability, performance, and usability fix
